    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .flexitype_team_two-item:hover .flexitype_team_two-item-content-social ul li a i' => 'background: {{VALUE}}',
                ],
                'condition' => [
                    'select_design' => ['design-1', 'design-2'],
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .flexitype_team-item-content-social ul li a i' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_two-item-content-social ul li a i' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_three-item-image-social ul li a i' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .flexitype_team-item-content-social ul li a i' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .flexitype_team_two-item-content-social ul li a i' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .flexitype_team_three-item-image-social ul li a i' => 'width: {{SIZE}}{{UNIT}};height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );        
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .flexitype_team-item-content-social ul li a i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .flexitype_team_two-item-content-social ul li a i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .flexitype_team_three-item-image-social ul li a i' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .flexitype_team-item-content-social ul li a i:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_two-item:hover .flexitype_team_two-item-content-social ul li a i:hover' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_three-item-image-social ul li a i:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .flexitype_team-item-content-social ul li a i:hover' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_two-item:hover .flexitype_team_two-item-content-social ul li a i:hover' => 'background: {{VALUE}}',
                    '{{WRAPPER}} .flexitype_team_three-item-image-social ul li a i:hover' => 'background: {{VALUE}}',
                ],
            ]
        );
		$this->add_control(
