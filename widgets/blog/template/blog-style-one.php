            ...
            $post_query->the_post(); ?>
                ...
                <?php if ('yes' === $settings['blog_comment_image']): ?>
                ...
                <?php endif; ?>
                    <div class="blog_one-item-content">
                                ...
                                <ul>
                                    ...
                                    <?php if ('yes' === $settings['blog_comment_meta']): ?>
                                        <li><a href="<?php the_permalink(); ?>"><i class="far fa-comment-dots"></i>
                                            <?php
                                                if (function_exists('flexitype_comments_count')) {
                                                    flexitype_comments_count();
                                                }
                                            ?>
                                        </a></li>
                                    <?php endif; ?>
                        ...
                        <?php if (!empty($settings['blog_btn_text'])): ?>
                            <a class="flexitype-button <?php echo esc_attr( $settings['icon_align'] ); ?>" href="<?php the_permalink(); ?>">
