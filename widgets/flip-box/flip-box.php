    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .icon__box-item-content h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .icon__box-item.back .icon__box-item-content h5',
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .icon__box-item.back .icon__box-item-content h5' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .icon__box-item.back .icon__box-item-content h5 a:hover' => 'color: {{VALUE}}',
                ],
                'condition' => [
                    'back_title_link[url]!' => '',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .icon__box-item.back .icon__box-item-content h5' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            <div class="flip_box_card">
                ...
                <div class="icon__box-item back custom_badge">
                    ...
                    <?php if (!empty($settings['back_box_icon']['value'])): ?>
                        <div class="icon__box-item-icon">
                            <?php Icons_Manager::render_icon($settings['back_box_icon'], ['aria-hidden' => 'true']); ?>
                        </div>
                    <?php endif; ?>
